...
export class CreatureInstance extends MainEntity<creatureRow> {
    ...
    get StandState() { return this.wrap(this.Addon.StandState); }
    get SheathState() { return this.wrap(this.Addon.SheathState); }
    get AnimTier() { return this.wrap(this.Addon.AnimTier); }
    get VisFlags() { return this.wrap(this.Addon.VisFlags); }
    get PvPFlags() { return this.wrap(this.Addon.PvPFlags); }
